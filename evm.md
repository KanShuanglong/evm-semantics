 ...
 // ------------------------------
    rule <k> SSTORE INDEX NEW => . ... </k>
         ...
         <account>
           ...
           <origStorage> ... (INDEX |-> ORIG) ... </origStorage>
           ...
         </account>
         <refund> R => R +Int Rsstore(SCHED, NEW, CURR, ORIG) </refund>
         <schedule> SCHED </schedule>

    rule <k> SSTORE INDEX _ ... </k>
         <id> ACCT </id>
         <account>
           <acctID> ACCT </acctID>
           <origStorage> STORAGE => STORAGE [ INDEX <- 0 ] </origStorage>
           ...
         </account>
